                ...
                <div class="col-12 col-lg-12">
                    ...
                    <div class="mt-4">
                            ...
                            <div class="row mb-2 mb-sm-0 py-25">
                                ...
                                <div class="d-none d-sm-block col-2 text-95">
                                    @if ($value->diskon <> null)
                                        {{ AllHelper::rupiah_v2($value->harga_barang).' x '.$value->diskon.'% = '.AllHelper::rupiah_v2($value->harga_diskon) }}
                                    @else
                                        {{ AllHelper::rupiah_v2($value->harga_barang) }}
                                    @endif
                                </div>
                        ...
                        <div class="row mt-3">
                            ...
                            <div class="col-12 col-sm-5 text-grey text-90 order-first order-sm-last">                                
                                <div class="row my-2 align-items-center bgc-primary-l3 p-2">
                                    ...
                                    <div class="col-7">
                                        <span class="text-150 text-success-d3 opacity-2">{{ AllHelper::rupiah_v2($invoice->ongkos_kirim) }}</span>
                                    </div>
                                    <div class="col-5 text-right">
                                        Total Pembayaran
                                    </div>
                        ...
                        <div>
                            ...
                            @else
                                <a href="{{ route('profil') }}" class="btn btn-info btn-bold text-white px-4 float-right mt-3 mt-lg-0">Kembali</a>
                            @endif
                        </div>

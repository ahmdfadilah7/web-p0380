...
<div class="container-fluid">
    <div class="row px-xl-5">
        <div class="col-lg-8 table-responsive mb-5">
            <div class="d-flex bg-light justify-content-between p-3">
                @if($transaksiCount > 0)                        
                    <h5>
                        Tanggal : <span class="text-dark">{{ date('d M Y', strtotime($invoice->created_at)) }}</span>
                    </h5>
                    <h5 class="text-dark">
                ...
                @else
                    <h5>
                        Tanggal : <span class="text-dark">{{ date('d M Y') }}</span>
                    </h5>
                @endif
            </div>
                    ...
                    @foreach ($transaksi as $value)
                        ...
                        <tr>
                            ...
                            <td class="align-middle">
                                ...
                                @if ($value->diskon <> null)
                                    <input type="hidden" name="harga_barang" value="{{ $value->harga_diskon }}">
                                @else
                            ...
                            <td class="align-middle">{{ AllHelper::rupiah($value->total) }}</td>
            ...
            <div class="bg-light p-30 mb-5">
                <div class="border-bottom pb-2">
                    ...
                    @foreach ($transaksi as $key => $value)
                        ...
                        <div class="d-flex justify-content-between mb-3">
                            ...
                            <h6>{{ AllHelper::rupiah($value->total) }}</h6>
                        </div>
                ...
                <div class="pt-2">
                    <div class="d-flex justify-content-between mt-2">
                        <h5>Total</h5>
                        <h5>{{ AllHelper::rupiah(array_sum($total)) }}</h5>
                    </div>
                    @if($transaksiCount > 0)

...
<div class="container-fluid bg-dark text-secondary mt-5 pt-5">
    <div class="row px-xl-5 pt-5">
        <div class="col-lg-7 col-md-12 mb-5 pr-3 pr-xl-5">
            ...
            <p class="mb-4">{{ strip_tags(Str::substr($setting->about_us, 3, 130)) }}... <a href="{{ route('about') }}"><i>Selengkapnya</i></a></p>            
        </div>
        <div class="col-lg-5 col-md-12">
            <div class="row">
                ...
                <div class="col-md-6 col-sm-12 mb-5">
                    ...
                    <div class="d-flex flex-column justify-content-start">
                        <div class="mb-2"><i class="fa fa-map-marker-alt text-primary mr-3"></i>{{ strip_tags($setting->alamat) }}</div>

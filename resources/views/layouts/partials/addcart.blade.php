                        ...
                        <div class="col-md-12">
                            ...
                            <div id="diskon">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="diskon" id="diskonBarang" readonly class="form-control">
                                </div>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="stok" id="stokBarang" readonly class="form-control">
                            </div>
                        </div>
                        <div class="col-md-6 col-sm-12">
                            <div class="form-group">
                                <label for="" class="form-label">Kuantitas</label><br>

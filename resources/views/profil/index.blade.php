                                ...
                                <tbody>
                                    @foreach ($pesananbelumdibayar as $key => $value)
                                        <tr>
                                            ...
                                            <td>
                                                {{ $value->kode_invoice }}
                                                <a href="{{ route('keranjang.invoice_pembayaran', $value->kode_invoice) }}" class="btn btn-info btn-sm"><i class="fa fa-eye"></i></a>
                                            </td>
                                            ...
                                            <td>
                                                {{ AllHelper::rupiah($value->total_invoice) }}
                                            </td>
                                            <td>
                                ...
                                <tbody>
                                    @foreach ($pesananmenunggukonfirmasi as $key => $value)
                                        <tr>
                                            ...
                                            <td>
                                                {{ $value->kode_invoice }}
                                                <a href="{{ route('profil.invoice_pembayaran', $value->kode_invoice) }}" class="btn btn-info btn-sm"><i class="fa fa-eye"></i></a>
                                            </td>
                                            <td>{{ $value->jasakirim }}</td>
                                            <td>{{ $value->nama_bank }}</td>
                                            <td>
